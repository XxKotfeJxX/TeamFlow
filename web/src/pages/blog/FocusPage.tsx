      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 space-y-16 leading-relaxed">
        ...
        <section>
          ...
          <p>
            ...
            допомагає сфокусуватись на пріоритетах. TeamFlow дозволяє робити
            це прямо в календарі — позначай свої головні цілі на день, і
            система нагадає тобі про них перед стартом роботи.
          </p>
          <img
        ...
        <section>
          ...
          <p>
            Парадоксально, але щоб залишатись сфокусованим — потрібно
            вчасно розфокусуватись. TeamFlow пропонує короткі мікропаузи між
            задачами: розтяжка, подих, або просто зміна візуального контенту.
          </p>
          <img
        ...
        <section>
          ...
          <p>
            ...
            прибираються усі другорядні панелі, залишається лише те, що
            дійсно важливо — завдання, час, і мета.
          </p>
          <img
        ...
        <section>
          ...
          <p>
            ...
            Результат: на 27% більше виконаних задач і вдвічі менше
            перерваних спринтів.
          </p>
        </section>
