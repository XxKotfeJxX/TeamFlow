    ...
    <div className="min-h-screen flex flex-col bg-gray-50 text-gray-800">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 space-y-16 leading-relaxed">
        <section>
          ...
          <p>
            Найчастіша причина хаосу — коли кожен веде свій список справ: хтось
            у нотатках, хтось у Telegram, а хтось просто в голові. TeamFlow
            дозволяє створити спільний таск-лист із дедлайнами, пріоритетами та
            відповідальними. Це усуває плутанину та зберігає прозорість процесу.
          </p>
          <img
        ...
        <section>
          ...
          <p>
            Ми створили календар, який поєднує особисті та командні події. Ти
            бачиш, коли колеги зайняті, і система автоматично попереджає про
            конфлікти. Кольори та теги допомагають швидко зорієнтуватись у
            пріоритетах.
          </p>
        ...
        <section className="text-lg italic text-gray-600 border-l-4 border-indigo-500 pl-4">
          <p>
            ...
            завдання, події, комунікацію і результат. TeamFlow допомагає саме в
            цьому.”
          </p>
        </section>
