// src/pages/blog/TeamworkPage.tsx
    ...
    <>
      ...
      <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-b from-blue-50 to-gray-50 text-gray-800">
        ...
        >
          ...
          <div className="absolute -bottom-40 -right-40 h-96 w-96 rounded-full bg-blue-400/20 blur-3xl" />
        </motion.div>
        ...
        <main className="relative z-10 max-w-6xl mx-auto flex flex-col items-center justify-start overflow-x-hidden">
          ...
          <section className="w-full py-16 px-6 md:px-12 lg:px-24 space-y-20 leading-relaxed">
            ...
            <motion.section
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="text-lg italic text-gray-600 border-l-4 border-indigo-500 pl-6 bg-white/60 rounded-xl p-6 shadow-sm"
            >
              <p>{tb("quote")}</p>
            </motion.section>
          ...
          {/* CTA Section */}
          <section className="relative w-full overflow-hidden bg-gradient-to-r from-indigo-600 to-blue-600 text-white py-20 px-6 md:px-12 lg:px-24 text-center rounded-t-[2rem]">
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <Button
                size="lg"
                className="rounded-2xl px-8 py-3 text-lg bg-white text-indigo-700 font-semibold hover:bg-gray-100 shadow-md hover:shadow-lg transition"
