          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-24">
            {platformCards.map((item, i) => (
              <motion.div
                ...
                className="bg-white/70 backdrop-blur-md border border-gray-100 rounded-2xl shadow-md hover:shadow-lg p-8 flex flex-col items-center text-center transition-transform"
              >
                ...
                {!item.isMobile ? (
                  <a
                    href={item.link}
                    className="bg-blue-600 text-white hover:bg-blue-700 px-6 py-3 rounded-2xl font-medium flex items-center shadow-sm hover:shadow-md transition"
                  >
