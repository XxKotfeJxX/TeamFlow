      ...
      <main className="flex-1 max-w-5xl mx-auto px-6 py-16">
        <section className="text-center space-y-6 text-lg leading-relaxed max-w-3xl mx-auto">
          <p>
            ...
            яка поєднує календар, завдання, чати та відео-дзвінки в одному просторі.
          </p>
          <p>
            Ідея з’явилася з бажання зробити співпрацю в командах більш організованою 
            та зрозумілою. Ми віримо, що ефективна комунікація — це ключ до успіху будь-якого проєкту.
          </p>
          <p>
            Наш фокус — <span className="font-semibold">продуктивність, прозорість і простота</span>.  
            Ми прагнемо створювати інструменти, які не перевантажують, а надихають.
          </p>
        </section>
