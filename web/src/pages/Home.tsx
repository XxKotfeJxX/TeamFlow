...
export default function Home() {
  return (
    <>
        ...
        <section className="w-full bg-white pt-32 pb-20 px-6 md:px-12 lg:px-24 flex flex-col lg:flex-row items-center gap-10">
          <div className="flex-1">
            ...
            <div className="flex gap-4">
              <Button className="px-6 py-3 text-lg text-white bg-blue-600 hover:bg-blue-700">Спробувати безкоштовно</Button>
              <Button variant="outline" className="px-6 py-3 text-lg text-blue-600 border-blue-600 hover:bg-blue-50">
                Дізнатися більше
      ...
      {/* 🔥 Footer Поза обмеженим контейнером */}
      <Footer />
    </>
  );
}
