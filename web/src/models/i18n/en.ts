...
The goal — to make teamwork not only productive but enjoyable.`,
  ...
  loginPage: {
    ...
    resetPlaceholder: "your@email.com",
    resetButton: "Recover",
    cancelButton: "Cancel",
    errorUserNotFound: "User not found",
    errorWrongPassword: "Incorrect password",
    resetUserNotFound: "No user found with that email",
  ...
  registerPage: {
    ...
    errorLoginRequired: "Please enter a username",
    errorPasswordsMismatch: "Passwords do not match",
    errorInvalidEmail: "Invalid email format",
    errorAgreeRequired: "You must agree to the privacy policy",
  ...
  errorPage: {
    ...
    error401Title: "Authorization required",
    error401Hint: "Please sign in to continue.",
    error403Title: "Access denied",
    error403Hint: "You don’t have permission to perform this action.",
    error404Title: "Page not found",
    error404Hint: "The link might be outdated or incorrect.",
    error429Title: "Too many requests",
    error429Hint: "Take a short break — it’ll work again soon.",
    error500Title: "Something went wrong",
    error500Hint: "That’s on us. We’re already looking into it.",
    error502Title: "Bad gateway",
    error502Hint: "The intermediary server returned an invalid response.",
    error503Title: "Service unavailable",
    error503Hint: "The server is overloaded or under maintenance.",
    error504Title: "Gateway timeout",
    error504Hint: "The response took too long.",
    errorUnknownTitle: "Unknown error",
    errorUnknownHint: "We’re investigating, but you can return home for now.",
    back: "Back",
    home: "Home",
    refresh: "Refresh",
    report: "Report",
    refreshTitle: "Refresh page",
    reportTitle: "Send error report",
