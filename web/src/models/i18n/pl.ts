...
Celem jest uczynienie współpracy zespołowej nie tylko skuteczną, ale i przyjemną.`,
  ...
  loginPage: {
    ...
    loginPlaceholder: "Wpisz login lub email",
    passwordLabel: "Hasło",
    passwordPlaceholder: "Wpisz hasło",
    forgotPassword: "Zapomniałeś hasła?",
    loginButton: "Zaloguj się",
    noAccount: "Nie masz konta?",
    registerLink: "Utwórz je",
    resetTitle: "Odzyskiwanie hasła",
    resetLabel: "Wpisz swój adres e-mail",
    resetPlaceholder: "twoj@email.com",
    resetButton: "Odzyskaj",
    cancelButton: "Anuluj",
    errorUserNotFound: "Użytkownik nie został znaleziony",
    errorWrongPassword: "Nieprawidłowe hasło",
    resetUserNotFound: "Nie znaleziono użytkownika o tym adresie e-mail",
    resetInstructionSent:
      "Instrukcje dotyczące odzyskiwania hasła wysłano na twój e-mail.",
  },
  ...
  registerPage: {
    ...
    agreeText: "Zgadzam się z",
    privacyPolicy: "polityką prywatności",
    registerButton: "Utwórz konto",

    ruleLength: "Minimum 8 znaków",
    ruleUppercase: "Przynajmniej jedna wielka litera",
    ruleLowercase: "Przynajmniej jedna mała litera",
    ruleDigit: "Przynajmniej jedna cyfra",
    ruleSpecial: "Przynajmniej jeden znak specjalny",

    errorLoginRequired: "Wpisz login",
    errorPasswordsMismatch: "Hasła nie są takie same",
    errorInvalidEmail: "Nieprawidłowy format adresu e-mail",
    errorAgreeRequired: "Musisz zaakceptować politykę prywatności",
    errorEmailExists: "Użytkownik z tym adresem e-mail już istnieje",
    passwordNotValid: "Hasło nie spełnia wymagań:",
  },

  errorPage: {
    errorCode: "Kod błędu",
    error401Title: "Wymagane logowanie",
    error401Hint: "Zaloguj się, aby kontynuować.",
    error403Title: "Dostęp zabroniony",
    error403Hint: "Wygląda na to, że nie masz uprawnień do tej akcji.",
    error404Title: "Nie znaleziono strony",
    error404Hint: "Link może być nieaktualny lub błędny.",
    error429Title: "Zbyt wiele żądań",
    error429Hint: "Zrób krótką przerwę — wkrótce zadziała ponownie.",
    error500Title: "Coś poszło nie tak",
    error500Hint: "To po naszej stronie. Już nad tym pracujemy.",
    error502Title: "Błędna brama",
    error502Hint: "Serwer pośredni zwrócił nieprawidłową odpowiedź.",
    error503Title: "Usługa niedostępna",
    error503Hint: "Serwer jest przeciążony lub w trakcie konserwacji.",
    error504Title: "Przekroczono limit czasu bramy",
    error504Hint: "Odpowiedź zajęła zbyt dużo czasu.",
    errorUnknownTitle: "Nieznany błąd",
    errorUnknownHint: "Już to badamy, ale możesz wrócić na stronę główną.",
    back: "Wstecz",
    home: "Strona główna",
    refresh: "Odśwież",
    report: "Zgłoś błąd",
    refreshTitle: "Odśwież stronę",
    reportTitle: "Wyślij raport o błędzie",
    needHelp: "Potrzebujesz pomocy? Skontaktuj się z naszym",
    support: "wsparciem",
  },
};
